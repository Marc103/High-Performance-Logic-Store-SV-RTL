...
module top #(
    ...
    localparam MULTISTAGE_FANOUT_REGISTERED_IN = 1,
    ...
    multistage_fanout #(
        ...
        .REGISTERED_IN(MULTISTAGE_FANOUT_REGISTERED_IN)
    ) dut (
        .clk_i(clk_i),
    ...
    */
    ...
    aligner #(
        ...
        .REGISTERED_IN_START_SYMBOL(ALIGNER_REGISTERED_IN_START_SYMBOL),

        // REGISTERED_IN respective
        .REGISTERED_IN_EQUAL(ALIGNER_REGISTERED_IN_EQUAL),
