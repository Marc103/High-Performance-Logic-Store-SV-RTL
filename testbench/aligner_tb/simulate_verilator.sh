...
TOP_MODULE="aligner_tb"
THREADS="${THREADS:-1}"

# Example parameter override:
#   ./simulate_verilator.sh -GDATA_WIDTH=8 -GSIZE=7 -GSTART_INDEX=2 -GREGISTERED_IN=0 \
#       -GREGISTERED_IN_START_SYMBOL=0 -GREGISTERED_IN_EQUAL=0 \
#       -GREGISTERED_IN_PRIORITY_ENCODER=0 -GREGISTERED_IN_REDUCTION_TREE=0 \
#       -GREGISTERED_IN_MULTISTAGE_MUX=0
...
Install a newer compiler in WSL, then rerun this script:
    ...
    CXX=g++-10 ./simulate_verilator.sh
