...
REM -------------------------------------------------
vlog %INCLUDE_FLAGS% -sv ..\reduction_tree_tb.sv
...
REM -------------------------------------------------
vsim -voptargs=+acc -c ^
    -g/reduction_tree_tb/DATA_WIDTH=%DATA_WIDTH% ^
    -g/reduction_tree_tb/GATE=%GATE% ^
    -g/reduction_tree_tb/REGISTERED_IN=%REGISTERED_IN% ^
    -g/reduction_tree_tb/LUTX=%LUTX% ^
    -g/reduction_tree_tb/GRADE=%GRADE% ^
    reduction_tree_tb ^
