...
class ReservoirMonitor #(type T, type I);
        ...
        forever begin
            ...
            if(pending_cycle) begin
                if(pending_valid) begin
                    reservoir_io_out.fill_ready_o = inf.fill_ready_o;
                    reservoir_io_out.drain_data_o = inf.drain_data_o;
                    reservoir_io_out.drain_valid_o = inf.drain_valid_o;
                    reservoir_io_out.drain_burstmark_o = inf.drain_burstmark_o;
                    io_obj.reservoir_io_out_q.push_back(reservoir_io_out);
                end
